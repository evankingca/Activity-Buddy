...
def seed_demo_data(apps, schema_editor):
    User = apps.get_model("browsing", "User")
    Activity = apps.get_model("browsing", "Activity")
    UserActivity = apps.get_model("browsing", "UserActivity")
    Preference = apps.get_model("browsing", "Preference")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("browsing", "0007_alter_connection_status"),
    ]
